...
#println("test1")
#m1 = programOfString("109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99")
#interpret(m1, BigInt[], true)

#println("test2")
#m2 = programOfString("1102,34915192,34915192,7,4,7,99,0")
#interpret(m2, BigInt[], true)

#println("test3")
#m3 = programOfString("104,1125899906842624,99")
#interpret(m3, BigInt[], true)
...
println("problem1")
testCode = 1
interpret(memory, BigInt[testCode], true)

println("problem2")
boostSignal = 2
interpret(memory, BigInt[boostSignal], true)
